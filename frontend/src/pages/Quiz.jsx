        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
            <span style={{ fontSize: '13px', fontWeight: '800', color: '#0B1F3A', letterSpacing: '0.5px', textTransform: 'uppercase' }}>
              {t.quizQuestion || 'Question'} {currentIdx + 1} <span style={{ color: '#94a3b8', fontWeight: '500' }}>/ {questions.length}</span>
            </span>
            <span style={{ fontSize: '13px', fontWeight: '800', color: '#3b82f6', background: 'rgba(59,130,246,0.08)', padding: '4px 12px', borderRadius: '20px' }}>
