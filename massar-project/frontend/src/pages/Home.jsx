  ...
  return (
    <div className="home-container">
      ...
      <div className="vision-section">
        <div className="section-label reveal-on-scroll"><Eye size={14} /> {t.visionLabel}</div>
        <h2 className="section-title reveal-on-scroll delay-100">
          {t.visionTitleMain} <span className="gradient-text">{t.visionTitleHighlight}</span>
        </h2>
        <p className="section-subtitle reveal-on-scroll delay-200">
          {t.visionSubtitle}
        </p>

        <div className="vision-grid">
          <div className="vision-card reveal-on-scroll delay-100">
          ...
          <div className="vision-card vision-card-center reveal-on-scroll delay-200">
          ...
          <div className="vision-card reveal-on-scroll delay-300">
      ...
      <div className="adaptive-features">
        <h2 className="section-title reveal-on-scroll">{t.engineTitle}</h2>
        <div className="luxe-grid">
          {[
            ...
            <div className={`luxe-card feature-card reveal-on-scroll delay-${(i + 1) * 100}`} key={i}>
      ...
      <div className="how-section">
        <div className="section-label reveal-on-scroll"><TrendingUp size={14} /> {t.processLabel}</div>
        <h2 className="section-title reveal-on-scroll delay-100">{t.howItWorksTitle}</h2>
        <div className="how-steps">
          {[
            ...
            <div className={`how-step reveal-on-scroll delay-${(i + 1) * 100}`} key={num}>
